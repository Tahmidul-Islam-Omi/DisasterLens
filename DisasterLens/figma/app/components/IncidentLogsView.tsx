...
const mockIncidents = [
  ...
  { id: 'INC-091', time: '10:30 AM', location: 'Sunamganj Route 4', type: 'Infrastructure', severity: 'High', source: 'News API', verified: true, status: 'Active' },
  ...
  { id: 'INC-089', time: '09:50 AM', location: 'Habiganj Center', type: 'Evacuation', severity: 'Moderate', source: 'Local Authority', verified: true, status: 'Resolved' },
  { id: 'INC-088', time: '09:20 AM', location: 'Sylhet River Bank', type: 'Flood Level', severity: 'Critical', source: 'IoT Sensor', verified: true, status: 'Active' },
  ...
  { id: 'INC-086', time: '08:10 AM', location: 'Sunamganj Rural', type: 'Stranded Group', severity: 'High', source: 'Hotline', verified: false, status: 'Investigating' },
];
            ...
            {mockIncidents.map((incident) => (
              ...
              >
                ...
                <div className="flex justify-between items-end">
                  <div>
                    <h4 className="text-sm font-semibold text-gray-900">{incident.type}</h4>
          ...
          {selectedIncident ? (
            <div className="p-6 h-full overflow-y-auto">
              <div className="flex justify-between items-start mb-6">
                <div>
                  <h3 className="text-lg font-bold text-gray-900 mb-1">{selectedIncident.type}</h3>
              ...
              <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900">{selectedIncident.location}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-medium text-gray-900">{selectedIncident.time}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className={`text-sm font-medium ${selectedIncident.severity === 'Critical' ? 'text-red-600' : 'text-orange-600'}`}>{selectedIncident.severity}</p>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl shadow-sm border border-gray-200">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm font-medium text-gray-900">{selectedIncident.source}</p>
