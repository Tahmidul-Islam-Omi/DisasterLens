            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {dynamicCoverages.slice().reverse().map(cov => (
                <div key={`update-${cov.id}`} className="border-l-2 border-green-500 pl-3">
                  ...
                  <p className="text-sm text-gray-800 font-medium">Updated coverage at {cov.location} ({cov.radius} km radius).</p>
                </div>
              ))}
              <div className="border-l-2 border-green-500 pl-3">
                <p className="text-xs text-gray-500 mb-0.5">Team Alpha • Just now</p>
                <p className="text-sm text-gray-800 font-medium">Covered 2 km radius from current location. Distributed 50 water kits.</p>
              </div>
              <div className="border-l-2 border-blue-500 pl-3">
                <p className="text-xs text-gray-500 mb-0.5">Team Bravo • 5 mins ago</p>
                <p className="text-sm text-gray-800 font-medium">Reached Sunamganj Sector 3. Beginning household visits.</p>
              </div>
              <div className="border-l-2 border-amber-500 pl-3">
                <p className="text-xs text-gray-500 mb-0.5">Team Charlie • 12 mins ago</p>
                <p className="text-sm text-gray-800 font-medium">Encountered blocked road at Netrokona East. Rerouting via Sector 4.</p>
              </div>
              <div className="border-l-2 border-green-500 pl-3">
                <p className="text-xs text-gray-500 mb-0.5">Team Delta • 15 mins ago</p>
                <p className="text-sm text-gray-800 font-medium">Completed evacuation assistance for 20 households in Habiganj.</p>
              </div>
            </div>
          </div>
        </div>
