        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="flex items-center gap-3 mt-4">
            ...
            <span className="text-[10px] text-blue-400 ml-auto flex items-center gap-1">
              <Clock className="w-3 h-3" /> {t('updated_4_mins')}
            </span>
          </div>
        </div>
      </div>
            ...
            <div>
              <div className="flex items-center gap-2 mb-4">
                ...
                <span className="bg-red-100 text-red-700 border border-red-200 px-2 py-0.5 rounded text-xs font-bold flex items-center gap-1">
                  <AlertTriangle className="w-3 h-3" /> {t('critical_danger_level')}
                </span>
              </div>
              
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3">
                <StatBox label={t('affected_pop_label')} value="420k" icon={Users} color="blue" />
                <StatBox label={t('fatalities')} value="12" icon={Activity} color="red" />
                <StatBox label={t('missing')} value="48" icon={Search} color="orange" />
                <StatBox label={t('rescued')} value="3,150" icon={Home} color="green" />
                <StatBox label={t('damages')} value="$14.2M" icon={TrendingUp} color="amber" />
                <StatBox label={t('exposed_infra_label')} value="124" icon={Building2} color="purple" />
              </div>
            </div>
