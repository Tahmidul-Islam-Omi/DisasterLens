                  ...
                  <div className="flex justify-between items-start mb-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-gray-500">{t(item.type.toLowerCase().replace(' ', '_'))} • {item.location}</p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="p-6 overflow-y-auto flex-1">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500 mt-1">{t(selectedItem.type.toLowerCase().replace(' ', '_'))} • {selectedItem.location}</p>
                  </div>
                </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div className="border border-gray-200 rounded-lg p-3">
                        ...
                        <span className="font-semibold text-gray-900">{t(selectedItem.hazard.toLowerCase())}</span>
                      </div>
                      <div className="border border-gray-200 rounded-lg p-3">
                        <div className="flex items-center gap-2 mb-1 text-gray-500">
                        ...
                        }`}>{selectedItem.severity} {t('risk_suffix')}</span>
                      </div>
                    </div>
                  </div>
