...
export default function DisasterDetailsView() {
  ...
  const verifiedNewsFeed = [
    {
      source: t('news_source_reuters'),
      time: t('news_time_10_mins_ago'),
      title: t('news_title_flash_floods_isolate_400k'),
      snippet: t('news_snippet_flash_floods_isolate_400k')
    },
    {
      source: t('news_source_bbc_news'),
      time: t('news_time_1_hr_ago'),
      title: t('news_title_shelters_overwhelmed'),
      snippet: t('news_snippet_shelters_overwhelmed')
    },
    {
      source: t('news_source_local_dispatch'),
      time: t('news_time_3_hrs_ago'),
      title: t('news_title_military_deployed_riverbed_alpha'),
      snippet: t('news_snippet_military_deployed_riverbed_alpha')
    },
    {
      source: t('news_source_natgov_alerts'),
      time: t('news_time_5_hrs_ago'),
      title: t('news_title_official_advisory_avoid_n2'),
      snippet: t('news_snippet_official_advisory_avoid_n2')
    }
  ];
  ...
  const disasters = [
    {
      ...
      type: 'Flood',
      date: t('active_started_oct'),
      status: 'Critical',
      region: t('northeast_region'),
    },
    {
      id: 2,
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 flex flex-col h-full">
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4">
                  {verifiedNewsFeed.map((item, index) => (
                    <NewsCard
  ...
  return (
    <div className="border-l-2 border-blue-200 pl-3 relative group">
      ...
      <div className="mt-1.5 flex items-center gap-1 text-[10px] font-bold text-blue-600 opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
        {t('read_full_source')} <ExternalLink className="w-3 h-3" />
      </div>
    </div>
  );
}